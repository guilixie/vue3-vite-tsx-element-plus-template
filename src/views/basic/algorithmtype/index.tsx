...
import AddDialog from './components/add-type-dialog'
...
export default defineComponent(() => {
  ...
  const { leftBtnOptions, formData, addDialogVisible, setAddDialogVisible, update, del } = btnOpt
  ...
  return () => (
    <div class="basic-algorithm-type">
      <SearchForm 
        form={queryForm} 
